...
public sealed class MediaProbe(IEventDispatcher dispatcher, MediaService mediaService)
{
    ...
    public async Task RunAsync(CancellationToken cancellationToken = default)
    {
        ...
        await _mediaService.SetCapabilitiesAsync(capabilities).ConfigureAwait(false);
